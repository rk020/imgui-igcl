...
ctl_result_t IntelGpuController::InitControlLibrary()
{
    ctl_result_t Result;
...
void IntelGpuController::DestroyControlLibrary() const
{
    ctlClose(ApiHandle);
    if (pDevices != nullptr)
        free(pDevices);
...
void IntelGpuController::FillPresetMapping()
{
...
void IntelGpuController::FillAppId(ctl_application_id_t& ApplicationUID) const
{
...
std::string IntelGpuController::GetPanelNameByType(ctl_display_output_types_t Type)
{
    switch (Type)
    {
...
std::vector<DisplayAdapter> IntelGpuController::GetDisplayAdapters()
{
    ctl_result_t Result;
...
std::vector<DisplayPanel> IntelGpuController::GetDisplayPanels(DisplayAdapter* pAdapter)
{
    ctl_result_t Result;
...
DisplayRrCaps IntelGpuController::GetDisplayRrCaps(DisplayPanel* pDisplay)
{
    DisplayRrCaps caps = {};
...
std::vector<RrPreset> IntelGpuController::GetSupportedPresets(DisplayPanel* pDisplay)
{
...
RrPreset IntelGpuController::GetRrPreset(DisplayPanel* pDisplay)
{
...
bool IntelGpuController::SetRrPreset(DisplayPanel* pDisplay, RrPreset* pPreset)
{
    ctl_intel_arc_sync_profile_params_t StIntelArcSyncProfileParams = {};
...
DisplayRrState IntelGpuController::GetRrState(DisplayPanel* pDisplay)
{
...
bool IntelGpuController::SetRrState(DisplayPanel* pDisplay, DisplayRrState* pRrState)
{
    ctl_intel_arc_sync_profile_params_t StIntelArcSyncProfileParams;
    ctl_result_t Result;
