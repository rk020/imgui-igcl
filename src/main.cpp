...
static GpuController g_GpuController;
...
{
    g_GpuController = GpuController();
    if (!g_GpuController.Init())
        return -1;
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Begin("ImGui Example", nullptr, ImGuiWindowFlags_NoDecoration);
            ...
            if (ImGui::Combo("##combo1", &currentAdapter, [](void* vec, int idx, const char** out_text)
            {
                ...
                return false;
            }, &g_GpuController.AdapterList, g_GpuController.AdapterList.size()))
            {
                g_GpuController.SetActiveAdapter(g_GpuController.pActiveController,
                                                 &g_GpuController.AdapterList[currentAdapter]);
            }
            ...
            if (ImGui::Combo("##combo2", &currentPanel, [](void* vec, int idx, const char** out_text)
            {
                ...
                return false;
            }, &g_GpuController.PanelList, g_GpuController.PanelList.size()))
            {
                g_GpuController.SetActivePanel(g_GpuController.pActiveController,
                                               &g_GpuController.PanelList[currentPanel]);
            }
